...
# VARIABLES
beat_to_play = "as.mp3"
slowdown_rate = 80 # higher value means slower speech... keep it between ~50 and 0 depending on how fast the beat is.
intro = 0 #amount in seconds it takes from the start of the beat to when the rapping should begin... how many seconds the AI waits to start rapping.
